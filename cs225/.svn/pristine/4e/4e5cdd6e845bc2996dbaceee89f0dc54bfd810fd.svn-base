...
class KDTree
{
    ...
    private:
        ...
        void make(std::vector< Point<Dim> > & newPoints, int minimum, int maximum, int curDim);
        void select(vector < Point<Dim>> & newPoints, int left, int right, int n, int curDim);
        int partition(vector < Point<Dim>> & newPoints, int left, int right, int pivot_index, int curDim);
        Point<Dim> find(const Point<Dim> & query, int minimum, int maximum, int curDim) const;
