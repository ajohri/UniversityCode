...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
	...
	{
		color.red = fadeColor1.red - ((dist * fadeColor1.red) / radius) + ((dist * fadeColor2.red) / radius);
		color.blue = fadeColor1.blue - ((dist * fadeColor1.blue) / radius) + ((dist * fadeColor2.blue) / radius);
		color.green = fadeColor1.green - ((dist * fadeColor1.green) / radius) + ((dist * fadeColor2.green) / radius);
	}	
